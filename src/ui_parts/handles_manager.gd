...
func render_handle_textures() -> void:
	normal_color = Configs.savedata.theme_config.handle_color
	hovered_color = Configs.savedata.theme_config.handle_hovered_color
	selected_color = Configs.savedata.theme_config.handle_selected_color
	hovered_selected_color = Configs.savedata.theme_config.handle_hovered_selected_color
	var inside_str := "#" + Configs.savedata.theme_config.handle_inner_color.to_html(false)
	var normal_str := "#" + Configs.savedata.theme_config.handle_color.to_html(false)
	var hovered_str := "#" + Configs.savedata.theme_config.handle_hovered_color.to_html(false)
	var selected_str := "#" + Configs.savedata.theme_config.handle_selected_color.to_html(false)
	var hovered_selected_str := "#" +\
			Configs.savedata.theme_config.handle_hovered_selected_color.to_html(false)
