...
func _ready() -> void:
	...
	shortcuts.add_shortcut("add_move", State.respond_to_key_input.bind("M"))
	shortcuts.add_shortcut("add_line", State.respond_to_key_input.bind("L"))
	shortcuts.add_shortcut("add_horizontal_line", State.respond_to_key_input.bind("H"))
	shortcuts.add_shortcut("add_vertical_line", State.respond_to_key_input.bind("V"))
	shortcuts.add_shortcut("add_closure", State.respond_to_key_input.bind("Z"))
	shortcuts.add_shortcut("add_elliptical_arc", State.respond_to_key_input.bind("A"))
	shortcuts.add_shortcut("add_cubic_bezier", State.respond_to_key_input.bind("C"))
	shortcuts.add_shortcut("add_shorthand_cubic_bezier", State.respond_to_key_input.bind("S"))
	shortcuts.add_shortcut("add_quadratic_bezier", State.respond_to_key_input.bind("Q"))
