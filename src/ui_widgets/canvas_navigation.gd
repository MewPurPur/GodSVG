...
func _unhandled_input(event: InputEvent) -> void:
	...
	if event is InputEventMouseMotion and (event.button_mask & MOUSE_BUTTON_MASK_MIDDLE or\
	(Configs.savedata.pan_with_lmb and event.button_mask & MOUSE_BUTTON_MASK_LEFT)):
