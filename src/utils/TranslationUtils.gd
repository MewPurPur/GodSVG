...
static func get_action_description(action_name: String, for_button := false) -> String:
	match action_name:
		...
		"add_move": return get_path_command_description("M")
		"add_line": return get_path_command_description("L")
		"add_horizontal_line": return get_path_command_description("H")
		"add_vertical_line": return get_path_command_description("V")
		"add_closure": return get_path_command_description("Z")
		"add_elliptical_arc": return get_path_command_description("A")
		"add_quadratic_bezier": return get_path_command_description("Q")
		"add_shorthand_quadratic_bezier": return get_path_command_description("T")
		"add_cubic_bezier": return get_path_command_description("C")
		"add_shorthand_cubic_bezier": return get_path_command_description("S")
...
static func get_layout_part_name(layout_part: Utils.LayoutPart) -> String:
	match layout_part:
		...
		Utils.LayoutPart.CANVAS: return Translator.translate("Canvas")
