...
static func setup_panelcontainer(theme: Theme) -> void:
	...
	stylebox.bg_color = GlobalSettings.common_panel_inner_color
	stylebox.border_color = GlobalSettings.common_panel_border_color
	...
	dark_stylebox.bg_color = GlobalSettings.dark_panel_color
	...
	overlay_stylebox.bg_color = GlobalSettings.overlay_panel_inner_color
	overlay_stylebox.border_color = GlobalSettings.overlay_panel_border_color
	...
	side_tabbar_stylebox.bg_color = GlobalSettings.tabbar_background_color
	...
	panel_stylebox.bg_color = GlobalSettings.tab_container_panel_inner_color
	panel_stylebox.border_color = GlobalSettings.tab_container_panel_border_color
...
static func setup_button(theme: Theme) -> void:
	...
	normal_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_normal
	normal_button_stylebox.border_color = GlobalSettings.common_button_border_color_normal
	theme.set_stylebox("normal", "Button", normal_button_stylebox)
	
	var hover_button_stylebox := button_stylebox.duplicate()
	hover_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_hover
	hover_button_stylebox.border_color = GlobalSettings.common_button_border_color_hover
	theme.set_stylebox("hover", "Button", hover_button_stylebox)
	
	var pressed_button_stylebox := button_stylebox.duplicate()
	pressed_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_pressed
	pressed_button_stylebox.border_color = GlobalSettings.common_button_border_color_pressed
	theme.set_stylebox("pressed", "Button", pressed_button_stylebox)
	
	var disabled_button_stylebox := button_stylebox.duplicate()
	disabled_button_stylebox.bg_color = GlobalSettings.common_inner_color_disabled
	disabled_button_stylebox.border_color = GlobalSettings.common_border_color_disabled
	...
	focus_button_stylebox.border_color = GlobalSettings.focus_color
	...
	normal_icon_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_normal
	normal_icon_button_stylebox.border_color = GlobalSettings.common_button_border_color_normal
	...
	hover_icon_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_hover
	hover_icon_button_stylebox.border_color = GlobalSettings.common_button_border_color_hover
	...
	pressed_icon_button_stylebox.bg_color = GlobalSettings.common_button_inner_color_pressed
	pressed_icon_button_stylebox.border_color = GlobalSettings.common_button_border_color_pressed
	...
	disabled_icon_button_stylebox.bg_color = GlobalSettings.common_inner_color_disabled
	disabled_icon_button_stylebox.border_color = GlobalSettings.common_border_color_disabled
	...
	theme.set_color("icon_normal_color", "LeftConnectedButton", GlobalSettings.icon_normal_color)
	theme.set_color("icon_hover_color", "LeftConnectedButton", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "LeftConnectedButton", GlobalSettings.icon_pressed_color)
	...
	normal_left_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_normal
	normal_left_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_normal
	...
	hover_left_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_hover
	hover_left_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_hover
	...
	pressed_left_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_pressed
	pressed_left_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_pressed
	...
	theme.set_color("icon_normal_color", "LeftConnectedButtonTransparent", GlobalSettings.icon_normal_color)
	theme.set_color("icon_hover_color", "LeftConnectedButtonTransparent", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "LeftConnectedButtonTransparent", GlobalSettings.icon_pressed_color)
	...
	normal_left_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_normal
	...
	hover_left_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_hover
	...
	pressed_left_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_pressed
	...
	theme.set_color("icon_normal_color", "RightConnectedButton", GlobalSettings.icon_normal_color)
	theme.set_color("icon_hover_color", "RightConnectedButton", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "RightConnectedButton", GlobalSettings.icon_pressed_color)
	...
	normal_right_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_normal
	normal_right_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_normal
	...
	hover_right_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_hover
	hover_right_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_hover
	...
	pressed_right_connected_button_stylebox.bg_color = GlobalSettings.connected_button_inner_color_pressed
	pressed_right_connected_button_stylebox.border_color = GlobalSettings.connected_button_border_color_pressed
	...
	theme.set_color("icon_normal_color", "RightConnectedButtonTransparent", GlobalSettings.icon_normal_color)
	theme.set_color("icon_hover_color", "RightConnectedButtonTransparent", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "RightConnectedButtonTransparent", GlobalSettings.icon_pressed_color)
	...
	normal_right_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_normal
	...
	hover_right_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_hover
	...
	pressed_right_connected_button_transparent_stylebox.border_color = GlobalSettings.connected_button_border_color_pressed
	...
	normal_translucent_button_stylebox.bg_color = GlobalSettings.translucent_button_color_normal
	...
	hover_translucent_button_stylebox.bg_color = GlobalSettings.translucent_button_color_hover
	...
	pressed_translucent_button_stylebox.bg_color = GlobalSettings.translucent_button_color_pressed
	...
	disabled_translucent_button_stylebox.bg_color = GlobalSettings.translucent_button_color_disabled
	...
	theme.set_color("icon_normal_color", "FlatButton", GlobalSettings.icon_normal_color)
	theme.set_color("icon_hover_color", "FlatButton", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "FlatButton", GlobalSettings.icon_pressed_color)
	...
	hover_flat_button_stylebox.bg_color = GlobalSettings.flat_button_color_hover
	...
	pressed_flat_button_stylebox.bg_color = GlobalSettings.flat_button_color_pressed
	...
	disabled_flat_button_stylebox.bg_color = GlobalSettings.flat_button_color_disabled
	...
	theme.set_color("icon_normal_color", "ContextButton", GlobalSettings.context_icon_normal_color)
	theme.set_color("icon_hover_color", "ContextButton", GlobalSettings.icon_hover_color)
	theme.set_color("icon_pressed_color", "ContextButton", GlobalSettings.icon_hover_color)
	...
	hover_context_button_stylebox.bg_color = GlobalSettings.flat_button_color_hover
	...
	pressed_context_button_stylebox.bg_color = GlobalSettings.flat_button_color_pressed
	...
	disabled_context_button_stylebox.bg_color = GlobalSettings.flat_button_color_disabled
	...
	theme.set_color("font_color", "TextButton", GlobalSettings.icon_toggled_off_color)
	theme.set_color("font_hover_color", "TextButton", GlobalSettings.icon_toggled_off_color)
	theme.set_color("font_pressed_color", "TextButton", GlobalSettings.icon_toggled_on_color)
	...
	normal_sidetab_stylebox.bg_color = GlobalSettings.normal_tab_color
	...
	pressed_sidetab_stylebox.bg_color = GlobalSettings.selected_tab_color
	pressed_sidetab_stylebox.border_color = GlobalSettings.selected_tab_border_color
	...
	hovered_sidetab_stylebox.bg_color = GlobalSettings.hovered_tab_color
...
static func setup_checkbox(theme: Theme) -> void:
	...
	hover_checkbox_stylebox.bg_color = GlobalSettings.flat_button_color_hover
	...
	disabled_checkbox_stylebox.bg_color = GlobalSettings.flat_button_color_disabled
...
static func setup_itemlist(theme: Theme) -> void:
	...
	hover_item_stylebox.bg_color = GlobalSettings.flat_button_color_hover
	theme.set_stylebox("hovered", "ItemList", hover_item_stylebox)
	
	var selected_item_stylebox := item_stylebox.duplicate()
	selected_item_stylebox.bg_color = GlobalSettings.flat_button_color_pressed
...
static func setup_lineedit(theme: Theme) -> void:
	...
	theme.set_color("caret_color", "LineEdit", GlobalSettings.common_caret_color)
	theme.set_color("font_color", "LineEdit", GlobalSettings.common_text_color)
	theme.set_color("font_placeholder_color", "LineEdit", GlobalSettings.common_subtle_text_color)
	theme.set_color("selection_color", "LineEdit", GlobalSettings.common_selection_color)
	...
	disabled_stylebox.bg_color = GlobalSettings.common_inner_color_disabled
	disabled_stylebox.border_color = GlobalSettings.common_border_color_disabled
	theme.set_stylebox("read_only", "LineEdit", disabled_stylebox)
	
	var normal_stylebox := stylebox.duplicate()
	normal_stylebox.bg_color = GlobalSettings.line_edit_background_color
	normal_stylebox.border_color = GlobalSettings.line_edit_normal_border_color
	theme.set_stylebox("normal", "LineEdit", normal_stylebox)
	
	var hover_stylebox := stylebox.duplicate()
	hover_stylebox.draw_center = false
	hover_stylebox.border_color = GlobalSettings.line_edit_hover_border_overlay_color
	theme.set_stylebox("hover", "LineEdit", hover_stylebox)
	
	var focus_stylebox := stylebox.duplicate()
	focus_stylebox.draw_center = false
	focus_stylebox.border_color = GlobalSettings.line_edit_focus_color
	...
	left_connected_disabled_stylebox.bg_color = GlobalSettings.common_inner_color_disabled
	left_connected_disabled_stylebox.border_color = GlobalSettings.common_border_color_disabled
	...
	left_connected_normal_stylebox.bg_color = GlobalSettings.line_edit_background_color
	left_connected_normal_stylebox.border_color = GlobalSettings.line_edit_normal_border_color
	...
	left_connected_hover_stylebox.border_color = GlobalSettings.line_edit_hover_border_overlay_color
	...
	left_connected_focus_stylebox.border_color = GlobalSettings.line_edit_focus_color
	...
	right_connected_normal_stylebox.bg_color = GlobalSettings.line_edit_background_color
	right_connected_normal_stylebox.border_color = GlobalSettings.line_edit_normal_border_color
	...
	right_connected_hover_stylebox.border_color = GlobalSettings.line_edit_hover_border_overlay_color
	...
	right_connected_focus_stylebox.border_color = GlobalSettings.line_edit_focus_color
	theme.set_stylebox("focus", "RightConnectedLineEdit", right_connected_focus_stylebox)
	
	theme.add_type("MiniLineEdit")
	theme.set_color("font_color", "MiniLineEdit", GlobalSettings.common_text_color)
	...
	mini_stylebox_normal.bg_color = GlobalSettings.line_edit_background_color
	mini_stylebox_normal.border_color = GlobalSettings.mini_line_edit_normal_border_color
	...
	mini_stylebox_hover.border_color = GlobalSettings.line_edit_hover_border_overlay_color
	...
	mini_stylebox_pressed.border_color = GlobalSettings.line_edit_focus_color
	...
	color_picker_line_edit_stylebox.bg_color = GlobalSettings.line_edit_background_color
...
static func setup_scrollbar(theme: Theme) -> void:
	...
	h_grabber_stylebox.bg_color = GlobalSettings.scrollbar_normal_color
	theme.set_stylebox("grabber", "HScrollBar", h_grabber_stylebox)
	
	var h_grabber_stylebox_hover := h_stylebox.duplicate()
	h_grabber_stylebox_hover.bg_color = GlobalSettings.scrollbar_hover_color
	...
	h_grabber_stylebox_pressed.bg_color = GlobalSettings.scrollbar_pressed_color
	...
	h_scroll_stylebox.bg_color = GlobalSettings.scrollbar_background_color
	...
	v_grabber_stylebox.bg_color = GlobalSettings.scrollbar_normal_color
	theme.set_stylebox("grabber", "VScrollBar", v_grabber_stylebox)
	
	var v_grabber_stylebox_hover := v_stylebox.duplicate()
	v_grabber_stylebox_hover.bg_color = GlobalSettings.scrollbar_hover_color
	...
	v_grabber_stylebox_pressed.bg_color = GlobalSettings.scrollbar_pressed_color
	...
	v_scroll_stylebox.bg_color = GlobalSettings.scrollbar_background_color
...
static func setup_separator(theme: Theme) -> void:
	...
	stylebox.color = GlobalSettings.common_separator_color
...
static func setup_label(theme: Theme) -> void:
	...
	theme.set_color("selection_color", "RichTextLabel", GlobalSettings.common_selection_color)
...
static func setup_tabcontainer(theme: Theme) -> void:
	...
	tab_hover_stylebox.bg_color = GlobalSettings.hovered_tab_color
	...
	tab_selected_stylebox.bg_color = GlobalSettings.selected_tab_color
	tab_selected_stylebox.border_color = GlobalSettings.selected_tab_border_color
	...
	tab_unselected_stylebox.bg_color = GlobalSettings.normal_tab_color
	...
	tabbar_background_stylebox.bg_color = GlobalSettings.tabbar_background_color
...
static func setup_textedit(theme: Theme) -> void:
	...
	theme.set_color("selection_color", "TextEdit", GlobalSettings.common_selection_color)
