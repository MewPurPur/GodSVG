...
var common_caret_color := Color("ddeeff", 0.87)
var common_selection_color := Color("668cff66")
var common_text_color := Color("ddeeff")
var common_subtle_text_color := Color("ffffff", 0.33)
...
var icon_toggled_on_color := Color("ddeeff", 0.87)

var translucent_button_color_normal := Color("ddeeff", 0.07)
var translucent_button_color_hover := Color("ddeeff", 0.14)
var translucent_button_color_pressed := Color("ddeeff", 0.27)
var translucent_button_color_disabled := Color("05060755")
var flat_button_color_hover := Color("ddeeff", 0.07)
var flat_button_color_pressed := Color("ddeeff", 0.2)
