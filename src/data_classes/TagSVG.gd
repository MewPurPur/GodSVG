...
signal child_attribute_changed(complete: bool)
...
func emit_child_attribute_changed(complete: bool) -> void:
	child_attribute_changed.emit(complete)

func emit_attribute_changed(complete: bool) -> void:
	super(complete)
	resized.emit()
