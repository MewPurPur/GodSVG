...
const COMMENTS_DICT: Dictionary[String, String] = {
	...
	"Dash": "Refers to the dashes of a dashed stroke.",
	"Gap": "Refers to the gaps in a dashed stroke.",
	"Dash length": "Refers to the dashes of a dashed stroke.",
	...
	"Points to insert": "Refers to a number of points.",
	"Set as initial": "Refers to, for example, changing which point in a polygon counts as \"first\".",
